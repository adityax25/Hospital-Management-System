    ...
    return (
        <div>
            ...
            <Row>
                ...
                <Col xs={12} md={6} lg={4}>
                <Link className="medlinks" to={`/patient/${user_id}/report`}>
            ...
            <Row>
            <Col xs={12} md={6}>
                <Link className="medlinks" to={`/patient/${user_id}/bills/current`}>
                    <Card bg="primary" text="light">
                        <Card.Body>
                        <Card.Title>Current Bill</Card.Title>
                        <Card.Text>
                            Check the reports of your patients
                            <br/>
                        </Card.Text>
                ...
                <Col xs={12} md={6}>
                <Link className="medlinks" to={`/patient/${user_id}/bills/previous`}>
                    <Card bg="secondary" text="light">
                        <Card.Body>
                        <Card.Title>Previous Bill</Card.Title>
                        <Card.Text>
                            Check the reports of your patients
                            <br/>
                        </Card.Text>
