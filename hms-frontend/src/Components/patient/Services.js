...
function Services(props) {
    ...
    return (
        <div>
            ...
            <Row>
                <Col xs={12} md={6}>
                    <Link className="medlinks" to={`/patient/${user_id}/services/ward`}>
                ...
                <Col xs={12} md={6}>
                    <Link className="medlinks" to={`/patient/${user_id}/services/medicine`}>
                ...
                <Row>
                <Col xs={12} md={6}>
                    <Link className="medlinks" to={`/patient/${user_id}/services/appointment`}>
                    <Card bg="secondary" style={{height:"20vh"}} text="light">
                        <Card.Body>
                        <Card.Title>Ask for an Appointment</Card.Title>
                        <Card.Text>
                            {/* Current Wards Avaliable are {ward_info.length} */}
                        </Card.Text>
                        </Card.Body>
                ...
                <Col xs={12} md={6}>
                    <Link className="medlinks" to={`/patient/${user_id}/services/test`}>
                    <Card style={{backgroundColor:"#a06fc5",height:"20vh"}} text="light">
                        <Card.Body>
                        <Card.Title>Book a Test</Card.Title>
                        <Card.Text>
                            {/* Current Wards Avaliable are {ward_info.length} */}
                        </Card.Text>
                        </Card.Body>
